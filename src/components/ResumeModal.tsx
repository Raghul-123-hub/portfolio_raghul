      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-[#111111] border border-white/20 rounded-3xl p-6 sm:p-10 text-[#E5E5E5] shadow-2xl z-10 max-h-[90vh] overflow-y-auto font-sans print:bg-white print:text-black print:p-0 print:border-0"
          >
            {/* Action Bar */}
